"use strict";
// shameless copy from https://github.com/for-GET/know-your-http-well/blob/master/json/status-codes.json
...
function getPhase(code) {
    ...
    var statusCode = exports.statusCodes.find(function (status) { return status.code === name; });
    return statusCode ? statusCode.phrase : '';
}
