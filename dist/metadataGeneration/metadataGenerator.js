...
var MetadataGenerator = (function () {
    function MetadataGenerator(entryFile, compilerOptions, decoratorPlugin) {
        if (decoratorPlugin === void 0) { decoratorPlugin = defaultDecoratorPlugin_1.defaultDecoratorPlugin; }
        this.decoratorPlugin = decoratorPlugin;
