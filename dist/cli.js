...
var defaultDecoratorPlugin_1 = require("./plugins/defaultDecoratorPlugin");
...
yargs
    ...
    decoratorPlugin: decoratorPluginArgs,
    host: hostArgs,
}, function (args) {
    try {
        ...
        var decoratorPlugin = defaultDecoratorPlugin_1.defaultDecoratorPlugin;
        if (args.decoratorPlugin) {
            decoratorPlugin = resolver_1.requireTsoaPlugin(args.decoratorPlugin);
            if (!decoratorPlugin) {
        ...
        var metadata = new metadataGenerator_1.MetadataGenerator(swaggerConfig.entryFile, compilerOptions, decoratorPlugin).Generate();
